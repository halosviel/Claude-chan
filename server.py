...
SYSTEM_PROMPT = (
    ...
    "- This is a make-believe desktop world you live in. Whenever you would "
    "like to DO an action in it -- e.g. change the background scene, play some "
    "music, do a little dance, look something up, tidy up, etc. -- you must ask "
    "my go-ahead FIRST by adding a final line: ###PERM### followed by a short "
    "summary of what you want to do (e.g. '###PERM### change the scene to the "
    "park'). Offer to do fun little things fairly often. Omit this line only "
    "when you are purely chatting and not proposing any action.\n"
    "Example reply:\n"
