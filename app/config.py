...
# Rendered speech is cached here, one .wav per (line, voice). It makes replaying
# a line from the backlog free -- across reloads too, since this outlives the
# page. Gitignored and safe to delete at any time.
